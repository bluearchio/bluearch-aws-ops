...
ALIAS_NAME="bluearch-aws-ops"
ASSET_NAME="bluearch-linux-x86_64.tar.gz"
...
case "$(uname -s)" in
  Linux) ;;
  *) fail "This installer supports Linux only. On macOS, use: brew install bluearchio/tap/bluearch-aws-ops" ;;
esac
